...
export class SearchPage implements OnInit {
    ...
    ionViewWillEnter() {
        this.getHouseList();
        this.listenSearchList();
    }



    /**
     *  search for the list in relation to the transmitted search
     */
    listenSearchList() {

        this.searchListSubscription = this.searchService.searchListSubject.subscribe((list) => {
            this.houseList = [];
            this.list = [];
            this.indexRep = 0;
            this.houseList = list;
